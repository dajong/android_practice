package com.mad1.tasklistdbik.database;
...
import com.mad1.tasklistdbik.data.List;
...
public class TaskListDB {
    ...
    public static final String TASK_COMPLETED =
            "date_completed";
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL(
                    "INSERT INTO task VALUES (2, 1, 'Get hair cut', " +
                            "'', '0', '0')");
            db.execSQL(
                    "INSERT INTO task VALUES (3, 2, 'check hours', " +
                            "'', '0', '0')");
        }
